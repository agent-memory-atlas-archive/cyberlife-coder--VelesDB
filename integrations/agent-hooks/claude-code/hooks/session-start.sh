#!/usr/bin/env bash
# SessionStart hook: tell the model to resume its working context — the one
# this conversation last saved or loaded, else the configured one — and, after
# a compaction, to load it again.
#
