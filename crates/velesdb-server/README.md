...
| Docker | Supported | Repository `Dockerfile`: `rust:1.98-bookworm` builder running the toolchain `rust-toolchain.toml` pins, `debian:bookworm-slim` runtime, non-root user, port 8080 |
